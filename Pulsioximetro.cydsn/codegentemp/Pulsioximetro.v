...
module top ;
	...
	wire [0:0] tmpOE__tono_net;
	wire [0:0] tmpFB_0__tono_net;
	wire [0:0] tmpIO_0__tono_net;
	wire [0:0] tmpINTERRUPT_0__tono_net;
	electrical [0:0] tmpSIOVREF__tono_net;

	cy_psoc3_pins_v1_10
		#(.id("ba444f53-4bdb-436a-9b52-a00aaeca548a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		tono
		 (.oe(tmpOE__tono_net),
		  .y({Net_77}),
		  .fb({tmpFB_0__tono_net[0:0]}),
		  .io({tmpIO_0__tono_net[0:0]}),
		  .siovref(tmpSIOVREF__tono_net),
		  .interrupt({tmpINTERRUPT_0__tono_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__tono_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
